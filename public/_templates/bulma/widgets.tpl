		...
		<div class="column is-9">
			<div class="box content">
				...
				<p>
					...
					<ol>
						<li>
							<strong>Get Jobs Widget</strong>: This widget is used to retrieve jobs based on their category, posting duration, and job type. You can also configure on how many jobs you want to display and order them on the basis of their publication date or even show randomly.
							<br /><br />
							<strong>List of parameters to be used in this implementation:</strong>
							<ul>
							...
							<br />
							<strong>Some sample codes using this</strong>:
							<ul>
						...
						<br />
						<li>
							<strong>Get Jobs by Company Widget</strong>: This widget is used to retrieve jobs based on their company and their count.
							<br /><br />
							<strong>List of parameters to be used in this implementation:</strong>
							<ul>
							...
							<br />
							<strong>A code for this get latest 10 jobs published by Google:</strong>
