                            ...
                            <div class="select">
                                ...
                                <div class="field">
                                    ...
                                    <div class="control">
                                        ...
                                        {if $errors.title}<div class="notification is-danger">&#9888; Please enter a job title.
                                        </div>{/if}
                                    </div>
                                </div>
                                ...
                                <div class="field">
									<div class="control">
                                        ...
                                        {if $errors.description}<div class="notification is-danger">&#9888; Please enter a
                                            description.</div>{/if}
                                    </div>
                                </div>
                                <div class="field">
                                ...
                                {if $ENABLE_RECAPTCHA}
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            {$the_captcha} {if $errors.captcha}<div class="notification is-danger">{$errors.captcha}
                                            </div>{/if}
                                        </div>
                                    </div>
                                {/if}
                                ...
                                <fieldset class="hidden">
                                    <input type="hidden" name="action" {if $job.id || $smarty.session.later_edit}value="edit"
                                        {else}value="publish" 
                                        {/if} />
                                    {if $smarty.session.later_edit}<input type="hidden" name="auth"
                                        value="{$smarty.session.later_edit}" />{/if}
